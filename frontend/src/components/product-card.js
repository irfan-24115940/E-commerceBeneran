  ...
  return `
    <div class="product-card ${layoutClass}">
      <div class="product-img-wrapper">
        <img src="${product.image}" alt="${productName}" class="product-img-clickable" data-id="${product.id}" style="cursor: pointer;" loading="lazy">
      ...
      <div class="product-info">
        ...
        <h3 class="product-name product-title product-img-clickable" data-id="${product.id}" style="cursor: pointer;">${productName}</h3>
