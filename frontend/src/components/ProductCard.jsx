  ...
  return (
    <div className="card group relative flex flex-col overflow-hidden" style={{ background: 'var(--surface)' }}>
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <Link to={`/products/${product.id}`} className="block hover:text-accent transition-colors">
          <h2 className="text-sm font-bold leading-snug line-clamp-2 mb-1" style={{ color: 'var(--text-primary)' }}>
            {product.title}
          </h2>
        </Link>
        {product.description && (
